...
%	\end{thm}
%	\begin{proof}
%		Betrakta matrisen $\mathbf{K}$ med elementen $\mathbf{K}_{ij}=k\left(\bfx_1, \bfx_2\right)$. Eftersom att $k$ är positivt definit är även $\mathbf{K}$ positivt definit alltså är alla egenvärden positivta och då även determinanten positivt \left(se till exempel \cite{Axler} eller nästan vilken bok om linjär algebra/matristeori som helst), det vill säga
%		\begin{equation*}
