...
\begin{enumerate}
	...
	\begin{align*}
		\langle f, g \rangle_k = \sum_{i=1}^{N} \sum_{j=1}^{N} \alpha_i \beta_j k(\bfx_i, \bfx_j) = \sum_{j=1}^{N} \sum_{i=1}^{N}  \beta_j \alpha_i k(\bfx_j, \bfx_i) = \langle g, f \rangle_k
	\end{align*}
	...
	\begin{equation*}
	\pushQED{\qed}
		\langle \lambda f, g \rangle_k	= \sum_{j=1}^{N} \beta_j \lambda f(\bfx_j) = \lambda \sum_{j=1}^{N} \beta_j f(\bfx_j) = \lambda\langle f, g \rangle_k \qedhere
		\popQED
	\end{equation*}
