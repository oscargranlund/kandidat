...
\begin{thm}\label{thm:primallinearproblem}
	...
	\end{aligned}
	\end{equation*}
	ifall träningsdatan $(\mathbf{x}_i,y_i)$ är sådant att klassificeringsproblemet är linjärt separabelt.
\end{thm}
