...
\begin{thm}\label{thm:primallinearproblem}
	Låt $\widehat{\bfbeta},~\bfbeta \in \mathbb{R}^p$, $\beta_0,~\beta_1 \in \mathbb{R}$. Då är optimeringsproblemet
	\begin{equation}
	\begin{aligned}
	& \operatornamewithlimits{max}_{\widehat{\bfbeta},\beta_0,\|\widehat{\bfbeta}\|=1} & & C\\
	& \text{så att} & & y_i(\mathbf{x}_i^\intercal\widehat{\bfbeta}+\beta_0)\geq C,\quad i=1,\dots,N
...
\begin{cor}\label{cor:inreproduktoptimering}
	Optimeringsproblemen i \ref{thm:primallinearproblem} är ekvivalenta med optimeringsproblemet
	\begin{equation}
	\begin{aligned}
