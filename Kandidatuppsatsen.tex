...
Inom statistiken och maskininlärningen finns många olika metoder för att försöka lösa \emph{klassificeringsproblem}, till exempel med hjälp av regressionsmodeller eller klusteranalys. I detta kapitel kommer en metod med en speciell egenskap att behandlas och generaliseras. Det speciella med stödvektormaskin-algoritmen är att lösningen kommer bero på endast ett fåtal av de observationer man matar in i algoritmen. Med andra ord ger algoritmen samma lösning även om man tar bort alla andra observationer. Observationerna som lösningen beror på kallas stödvektorer och därifrån kommer även termen stödvektormaskin.
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth, trim={0.5cm 2mm 0.5cm 6mm}, clip]{KandFigur1.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth, trim={0.5cm 2mm 0.5cm 6mm}, clip]{KandFigur2.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth, trim={0.5cm 4mm -5mm 4mm}, clip]{KandFigur3.pdf}
...
\begin{ex}
	...
	Nyttan av den Gaussiska kärnan syns i figur \ref{fig:jämförelse} där den Gaussiska kärnan jämförs med den polynomiella kärnan med graden $k$.
\end{ex}
...
%			\includegraphics[width=0.5\linewidth, trim={3.5cm 11mm 2.7cm 11mm}, clip]{KandFigur6.pdf}
			\includegraphics[width=1.05\linewidth, trim={0.5cm 2mm 0.5cm 6mm}, clip]{KandFigur6.pdf}
			
			\caption{\label{fig:RBF}Radiell basfunktion}
		\end{subfigure}%
		\begin{subfigure}{0.5\linewidth}
			\centering
			\includegraphics[width=1.05\linewidth, trim={0.5cm 2mm 0.5cm 6mm}, clip]{KandFigur7.pdf}
			\caption{\label{fig:Polkärna}Polynomiell kärna}
		\end{subfigure}
		\caption{\label{fig:jämförelse}Jämförelse mellan två olika kärnor}
