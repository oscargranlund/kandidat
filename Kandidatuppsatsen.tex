...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{KandFigur1.pdf}
\caption{\label{fig:separatinghyperplane}20 datapunkter med två separerande hyperplan (linje) där klassen $y=1$ har färgats blå och klassen $y=-1$ har färgats orange.}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{KandFigur2.pdf}
	\caption{\label{fig:mjukamarginaler}Löst exempel för oseparabelt data för 3 olika värden på $\gamma$.}
\end{figure}
\end{ex}
\begin{ex}
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{KandFigur3.pdf}
	\caption{\label{fig:kvadratisk}En lösning med optimala separerande hyperplan och kvadratisk utvidgning där endast mjuka marginaler inte hade fungerat.}
\end{figure}
\end{ex}
